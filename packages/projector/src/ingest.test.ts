...
const lines = [
  {
    kind: "event",
    id: "r1",
    subject: "gh.event.dungeonadventures.pr.opened.42",
  ...
  },
  {
    kind: "event",
    id: "r2",
    subject: "gh.event.dungeonadventures.pr.review_started.42",
  ...
  },
  {
    kind: "event",
    id: "r3",
    subject: "gh.event.dungeonadventures.pull_request_review.submitted.42",
  ...
  },
  {
    kind: "event",
    id: "r4",
    subject: "gh.event.dungeonadventures.pr.closed.42",
