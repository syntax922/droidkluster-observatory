...
| `NATS_STREAM` | `project` | yes | no | JetStream stream name. |
...
| `NATS_FILTER_SUBJECTS` | `gh.event.project.>,project.event.merge_decision.reached.>` | yes | no | Comma-separated subject filters for the durable consumer. |
